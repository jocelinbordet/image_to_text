...
def caption_image_beam_search(encoder, decoder, img, word_map, beam_size=3):
    ...
    while True:
        ...
        seqs_alpha = torch.cat(
            [
                seqs_alpha[prev_word_inds.long()],
                alpha[prev_word_inds.long()].unsqueeze(1),
            ],
            dim=1,
...
def visualize_attention(
    ...
    :param image_arr: image that has been captioned converted to numpy array
    :param seq: caption
    ...
    for t in range(len(words)):
        ...
        if smooth:
            ...
            alpha = skimage.transform.resize(current_alpha, [IMAGE_DIM, IMAGE_DIM])
